...
#else
IDirect3DDevice9* FixedFunctionShader::device;
#endif // FULL_MGE
...
#else
bool FixedFunctionShader::init(IDirect3DDevice9 * d, ID3DXEffectPool * pool) {
#endif // FULL_MGE
    device = d;
    constantPool = pool;
    ...
    for (; n --> 0; ) {
        ...
        if (light->type == D3DLIGHT_POINT) {
            ...
            if (light->falloff.x > 0) {
                ...
                bufferFalloffQuadratic[pointLightCount] = 5e-5f;
